...
namespace WebJobUniDAL {
    ...
    public class Company {
        ...
        public static int AddCompany(string compName, string industry, Int16 natureOfBusiness, string compNumber, DateTime dateRegistered, string URL, int clientID, int contactDetID, bool isVARreg, string VATNumb, string notes) {
            try {
                return (int)Adapter.InsertCompany(compName, industry, natureOfBusiness, compNumber, dateRegistered, URL, clientID, contactDetID, isVARreg, VATNumb, notes);
            }
            catch (Exception ex) {
        ...
        public static int AddCompany(string compName, string industry, Int16 natureOfBusiness, int clientID, int contactDetID) {
            try {
                return (int)Adapter.InsertCompany(compName, industry, natureOfBusiness, null, null, null, clientID, contactDetID, null, null, null);
            }
            catch (Exception ex) {
